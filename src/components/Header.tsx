...
export function Header() {
  ...
  return (
    <header
      className={`fixed inset-x-0 top-0 w-full z-50 header-height header-safe transition-colors duration-300 ${headerClass}`}
    >
      <div className="w-full h-full px-4 md:px-6 flex items-center justify-between">
        ...
        <button
          ...
          onClick={() => setOpen((v) => !v)}
          className={`lg:hidden inline-flex h-10 w-10 items-center justify-center rounded-lg border ${
            open
